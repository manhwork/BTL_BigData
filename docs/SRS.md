...
> **Tên dự án:** Hệ thống So sánh Giá Sản phẩm và Theo dõi Biến động Giá  
> **Phiên bản:** 1.1  
...
| --------- | ---------- | ---------------- | -------------------------------- |
| 1.0       | 2026-01-23 | Development Team | Phiên bản đầu tiên               |
| 1.1       | 2026-01-23 | Development Team | Bổ sung tính năng Phân loại Shop |
...
- **Loại shop (Shop Mall / Shop Yêu thích / Shop Rủi ro)**
- Thời gian tham gia
- Tỷ lệ phản hồi chat
...
### 2.2. Phân loại Shop (Shop Classification)

Hệ thống phân loại shop thành 3 cấp độ tin cậy để giúp người dùng đánh giá độ uy tín của người bán trước khi mua hàng.
...
- Shop chính hãng, được sàn TMĐT xác thực
- Thường là nhà phân phối chính thức hoặc thương hiệu
- Có cam kết chất lượng từ sàn TMĐT
...
- ❌ Giá thường cao hơn shop thường
- ❌ Ít khuyến mãi sâu

**Màu sắc hiển thị:** 🟢 Xanh lá (Green) - Tin cậy cao
...
- Shop có uy tín tốt, được nhiều người mua tin tưởng
- Không phải shop chính hãng nhưng chất lượng đảm bảo
- Có lượng bán hàng và đánh giá tích cực

**Tiêu chí nhận diện:**

- Có badge "Yêu thích" hoặc "Preferred" từ sàn TMĐT (nếu có)
- Rating >= 4.5/5.0
- Số lượng đánh giá >= 500
- Số lượng sản phẩm đã bán >= 5,000
- Tỷ lệ phản hồi chat >= 80%
- Tỷ lệ đơn hàng thành công >= 90%
- Thời gian tham gia >= 3 tháng
- Số lượng người theo dõi >= 1,000
- Tỷ lệ đánh giá tích cực (4-5 sao) >= 85%
...
- ⚠️ Có thể không phải hàng chính hãng
- ⚠️ Bảo hành có thể hạn chế hơn Mall

**Màu sắc hiển thị:** 🟡 Vàng (Yellow) - Tin cậy trung bình
...
- Shop mới, chưa có nhiều lịch sử bán hàng
- Shop có dấu hiệu đánh giá kém hoặc vi phạm
- Cần cân nhắc kỹ trước khi mua

**Tiêu chí nhận diện:**
Shop được đánh dấu "Rủi ro" nếu thỏa mãn **ít nhất 2** trong các điều kiện sau:

- Rating < 4.5/5.0
- Số lượng đánh giá < 100
- Số lượng sản phẩm đã bán < 1,000
- Tỷ lệ phản hồi chat < 70%
- Tỷ lệ đơn hàng thành công < 85%
- Thời gian tham gia < 1 tháng
- Có nhiều đánh giá 1-2 sao (>15%)
- Tỷ lệ hoàn tiền/khiếu nại cao (>10%)

**Cảnh báo:**

- ⚠️ Shop mới, chưa có uy tín
- ⚠️ Đánh giá thấp hoặc ít
- ⚠️ Có thể giao hàng chậm
- ⚠️ Chất lượng sản phẩm không đảm bảo
- ⚠️ Hỗ trợ khách hàng kém

**Lưu ý khi mua:**

- 🔍 Đọc kỹ đánh giá từ người mua trước
- 🔍 Kiểm tra chính sách đổi trả
- 🔍 Ưu tiên thanh toán khi nhận hàng (COD)
- 🔍 Chụp ảnh/video khi nhận hàng
- 🔍 Cân nhắc mua hàng giá trị thấp để test

**Màu sắc hiển thị:** 🔴 Đỏ (Red) - Cần cẩn trọng

---

#### 2.2.2. Thuật toán phân loại Shop

**Scoring System (Hệ thống chấm điểm):**

Mỗi shop được tính điểm từ 0-100 dựa trên các tiêu chí:
...
2. **Review_Score (15%):**
    - > = 10,000 reviews → 100 điểm
    - 5,000-9,999 reviews → 80 điểm
    - 1,000-4,999 reviews → 60 điểm
    - 500-999 reviews → 40 điểm
    - 100-499 reviews → 20 điểm
    - < 100 reviews → 10 điểm

3. **Sales_Score (20%):**
    - > = 100,000 sản phẩm → 100 điểm
    - 50,000-99,999 → 85 điểm
    - 10,000-49,999 → 70 điểm
    - 5,000-9,999 → 50 điểm
    - 1,000-4,999 → 30 điểm
    - < 1,000 → 15 điểm
...
7. **Badge_Score (5%):**
    - Official/Mall badge → 100 điểm
    - Preferred badge → 70 điểm
    - No badge → 30 điểm
...
#### 2.2.3. Hiển thị phân loại Shop

**Trên giao diện so sánh:**

```
┌─────────────────────────────────────────────────┐
│ 🏢 Shop Mall          Rating: ⭐ 4.8 (12,345)   │
│ ABC Official Store    Đã bán: 50,000+          │
│ ✓ Chính hãng ✓ Hoàn tiền 100%                  │
│ Giá: 1,200,000đ       [Xem shop] [Mua ngay]    │
└─────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────┐
│ ⭐ Shop Yêu thích     Rating: ⭐ 4.6 (3,456)    │
│ XYZ Store            Đã bán: 15,000+           │
│ ✓ Uy tín tốt ✓ Giá cạnh tranh                  │
│ Giá: 1,050,000đ      [Xem shop] [Mua ngay]    │
└─────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────┐
│ ⚠️ Shop Rủi ro        Rating: ⭐ 4.2 (89)       │
│ New Shop             Đã bán: 500+              │
│ ⚠️ Shop mới ⚠️ Cần cẩn trọng                    │
│ Giá: 950,000đ        [Xem shop] [Mua ngay]    │
└─────────────────────────────────────────────────┘
```
...
- Lý do phân loại
- Các chỉ số cụ thể (rating, số bán, thời gian tham gia)

---

#### 2.2.4. Lọc và sắp xếp theo loại Shop
...
#### 2.2.5. Cảnh báo và Khuyến nghị

**Cảnh báo tự động:**

Khi người dùng xem sản phẩm từ Shop Rủi ro, hiển thị popup:
...
[Tiếp tục xem] [Tìm shop khác]
```

**Gợi ý thay thế:**

Nếu sản phẩm có ở Shop Mall hoặc Shop Yêu thích:
...
⭐ XYZ Store (Shop Yêu thích)
   Giá: 1,050,000đ (+100,000đ)
...
#### 2.2.6. Cập nhật phân loại Shop

**Tần suất cập nhật:**

- **Shop Mall:** Kiểm tra mỗi tuần (ít thay đổi)
- **Shop Yêu thích:** Kiểm tra mỗi 3 ngày
- **Shop Rủi ro:** Kiểm tra mỗi ngày (có thể cải thiện nhanh)

**Tự động nâng/hạ hạng:**
...
Nếu shop trong watchlist thay đổi hạng:

```
📢 Thông báo
Shop "ABC Store" đã được nâng hạng từ
"Shop Rủi ro" lên "Shop Yêu thích"

Lý do:
• Rating tăng lên 4.6/5.0
• Số lượng bán tăng lên 5,000+
• Tỷ lệ đánh giá tích cực 90%

Bạn có thể yên tâm mua hàng hơn!
```

---

### 2.3. So sánh giá sản phẩm

#### 2.3.1. Quy trình so sánh
...
#### 2.3.3. Thuật toán matching sản phẩm
...
### 2.4. Theo dõi biến động giá theo thời gian

#### 2.4.1. Quy trình lưu trữ lịch sử giá
...
#### 2.4.2. Cấu trúc dữ liệu lịch sử giá
...
### 2.5. Cảnh báo giá tốt (Price Alert)

#### 2.5.1. Quy trình cảnh báo
...
product_listings:
  ...
  - seller_id (FK) - liên kết đến sellers
...
### 5.3. Bảng Sellers (Người bán/Shop)

```sql
sellers:
  - id (PK)
  - platform (shopee, lazada, tiki, v.v.)
  - platform_seller_id (ID shop trên sàn đó)
  - seller_name
  - seller_url
  - seller_rating
  - total_products
  ...
  - success_rate (tỷ lệ đơn hàng thành công %)
  - positive_review_rate (tỷ lệ đánh giá tích cực %)
  - return_rate (tỷ lệ hoàn tiền/khiếu nại %)
  - has_mall_badge (có badge Mall/Official)
  - has_preferred_badge (có badge Yêu thích/Preferred)
  - shop_type (mall, preferred, risky)
  - shop_score (điểm tin cậy 0-100)
  - last_score_updated_at
  - created_at
  - updated_at
```

### 5.4. Bảng Price_History (Lịch sử giá)
...
### 5.7. Bảng Price_Alerts (Cảnh báo giá)
...
### 5.8. Bảng Alert_History (Lịch sử cảnh báo)
...
### 5.9. Bảng User_Watchlist (Danh sách theo dõi)
...
### 5.10. Bảng Search_History (Lịch sử tìm kiếm)
...
# PHỤ LỤC A: TÓM TẮT TÍNH NĂNG PHÂN LOẠI SHOP
